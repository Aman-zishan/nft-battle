// backgrounds
import saiman from "./background/saiman.gif";
import astral from "./background/astral.gif";
import eoaalien from "./background/eoaalien.gif";
import cusat from "./background/cusat.jpg";
import heroImg from "./background/hero-img-gif.gif";
...
export const battlegrounds = [
  ...
  { id: "bg-cusat", image: cusat, name: "CUSAT Campus" },
];
